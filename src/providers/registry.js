...
const PROVIDERS = {
  ...
  opencodezen: {
    name: 'OpenCode Zen',
    baseUrl: 'https://api.openodezen.com/v1',
    authHeader: 'Authorization',
    authPrefix: 'Bearer ',
    models: ['gpt-4o', 'gpt-4o-mini', 'claude-3.5-sonnet', 'gemini-2.0-flash', 'deepseek-chat'],
    freeTier: true,
  },
  xkiro: {
    name: 'Xkiro',
    ...
    authHeader: 'Authorization',
    authPrefix: 'Bearer ',
    models: ['gpt-4o', 'gpt-4o-mini', 'claude-3.5-sonnet', 'gemini-2.0-flash', 'llama-3.3-70b-versatile'],
    freeTier: true,
  },
  freebuff: {
    name: 'FreeBuff Proxy',
    baseUrl: 'https://api.freebuff.com/v1',
    authHeader: 'Authorization',
    authPrefix: 'Bearer ',
    models: ['gpt-4o', 'gpt-4o-mini', 'claude-3.5-sonnet', 'gemini-2.0-flash', 'deepseek-chat'],
    freeTier: true,
